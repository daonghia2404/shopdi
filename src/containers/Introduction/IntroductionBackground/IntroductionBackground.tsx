...
import { TIntroductionBackgroundProps } from './IntroductionBackground.types';
import './IntroductionBackground.scss';

const IntroductionBackground: React.FC<TIntroductionBackgroundProps> = () => {
